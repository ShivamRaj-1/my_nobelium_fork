...
import SC from './shoppingCart.module.css'
...
export default function Shopping() {
    ...
    return (
        <div className={SC.main_background}>

            <div className={SC.top_section}>
                <h1>Biling Form</h1>
                <p>Customer Name</p>
                <input type="text" placeholder="Customer Name" onChange={(e) => setName(e.target.value)} />
            </div>


            {inputList}
            <button onClick={onAddBtnClick}>Add this item</button>
            <hr />
